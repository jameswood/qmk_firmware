...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_tkl_ansi(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                   MO(2),             KC_VOLU,         
      KC_TRNS, KC_TRNS, KC_TRNS,                          MAILME,                               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_MRWD, KC_VOLD, KC_MFFD   ),
  [2] = LAYOUT_tkl_ansi(
  ...
  switch (keycode) {
    case MAILME:
      if (record->event.pressed) {
        ...
        SEND_STRING("james@james-wood.com.au");
      } else {
